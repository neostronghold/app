...
export class HaLogoSvg extends LitElement {
  protected render(): TemplateResult {
    return html`<svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
...
export const haLogoSvg = html`<ha-logo-svg></ha-logo-svg>`;

export const neostrongholdLogoSvg = haLogoSvg;
